...
echo WORDPRESS_DATABASE_HOST=$WORDPRESS_DATABASE_HOST > /etc/profile
echo WORDPRESS_DATABASE_USER=$WORDPRESS_DATABASE_USER >> /etc/profile
echo WORDPRESS_DATABASE_PASSWORD=$WORDPRESS_DATABASE_PASSWORD >> /etc/profile
echo WORDPRESS_DATABASE_NAME=$WORDPRESS_DATABASE_NAME >> /etc/profile
echo WORDPRESS_DATABASE_PORT_NUMBER=$WORDPRESS_DATABASE_PORT_NUMBER >> /etc/profile
echo NGINX_HTTP_PORT_NUMBER=$NGINX_HTTP_PORT_NUMBER >> /etc/profile
echo NGINX_HTTPS_PORT_NUMBER=$NGINX_HTTPS_PORT_NUMBER >> /etc/profile