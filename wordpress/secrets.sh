...
echo WORDPRESS_DATABASE_HOST=$WORDPRESS_DATABASE_HOST > /etc/environment
echo WORDPRESS_DATABASE_USER=$WORDPRESS_DATABASE_USER >> /etc/environment
echo WORDPRESS_DATABASE_PASSWORD=$WORDPRESS_DATABASE_PASSWORD >> /etc/environment
echo WORDPRESS_DATABASE_NAME=$WORDPRESS_DATABASE_NAME >> /etc/environment
echo WORDPRESS_DATABASE_PORT_NUMBER=$WORDPRESS_DATABASE_PORT_NUMBER >> /etc/environment
echo NGINX_HTTP_PORT_NUMBER=$NGINX_HTTP_PORT_NUMBER >> /etc/environment
echo NGINX_HTTPS_PORT_NUMBER=$NGINX_HTTPS_PORT_NUMBER >> /etc/environment